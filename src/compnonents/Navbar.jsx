...
const Navbar = () => {
  ...
  const handleCategory = (category) => {
    const listByCategory = productArray.filter(
      (item) => item.category.name === category,
    );
    dispatch(setProductList(listByCategory));
    if (category === "All") {
  ...
  return (
    <div className="sticky top-0 z-100 flex h-16 items-center justify-between bg-white px-4 shadow-md md:h-20 md:justify-around md:px-2">
            ...
            <>
              ...
              <div className="absolute top-0 left-0 z-10 h-dvh w-78 overscroll-none bg-white">
                ...
                <ul className="">
                  <Link to="/category">
                    <li
                      className="flex cursor-pointer items-center justify-between px-5 py-2 font-semibold text-neutral-600 active:bg-neutral-200"
                  ...
                  <Link to="/category">
                    <li
                      className="flex cursor-pointer items-center justify-between px-5 py-2 font-semibold text-neutral-600 active:bg-neutral-200"
                      onClick={(e) => handleCategory("Shoes")}
                    >
                      Shoes
                      <span className="text-2xl font-semibold"> › </span>
                    </li>
                  ...
                  <Link to="/category">
                    <li
                      className="flex cursor-pointer items-center justify-between px-5 py-2 font-semibold text-neutral-600 active:bg-neutral-200"
                      onClick={(e) => handleCategory("Electronics")}
                    >
                      Electronics
                      <span className="text-2xl font-semibold"> › </span>
                    </li>
                  ...
                  <Link to="/category">
                    <li
                      className="flex cursor-pointer items-center justify-between px-5 py-2 font-semibold text-neutral-600 active:bg-neutral-200"
                      onClick={(e) => handleCategory("Furniture")}
                    >
                      Furniture
                      <span className="text-2xl font-semibold"> › </span>
                    </li>
                  ...
                  <Link to="/category">
                    <li
                      className="flex cursor-pointer items-center justify-between px-5 py-2 font-semibold text-neutral-600 active:bg-neutral-200"
                      onClick={(e) => handleCategory("Miscellaneous")}
                    >
                      Others
                      <span className="text-2xl font-semibold"> › </span>
                    </li>
      ...
      <ul className="hidden gap-5 md:flex">
        <Link to="/category">
          <li
            className="box-border flex h-20 cursor-pointer items-center justify-center border-b-4 border-transparent font-semibold hover:border-red-600 active:border-fuchsia-700"
            onClick={(e) => handleCategory("Clothes")}
          >
            Clothes
          </li>
        ...
        <Link to="/category">
          <li
            className="box-border flex h-20 cursor-pointer items-center justify-center border-b-4 border-transparent font-semibold hover:border-pink-500 focus:border-fuchsia-700"
            onClick={(e) => handleCategory("Shoes")}
          >
            Shoes
          </li>
        ...
        <Link to="/category">
          <li
            className="box-border flex h-20 cursor-pointer items-center justify-center border-b-4 border-transparent font-semibold hover:border-fuchsia-700 focus:border-fuchsia-700"
            onClick={(e) => handleCategory("Electronics")}
          >
            Electronics
          </li>
        ...
        <Link to="/category">
          <li
            className="box-border flex h-20 cursor-pointer items-center justify-center border-b-4 border-transparent font-semibold hover:border-green-500 focus:border-fuchsia-700"
            onClick={(e) => handleCategory("Furniture")}
          >
            Furniture
          </li>
        ...
        <Link to="/category">
          <li
            className="hover:border-yellow- box-border flex h-20 cursor-pointer items-center justify-center border-b-4 border-transparent font-semibold hover:border-yellow-300 focus:border-fuchsia-700"
            onClick={(e) => handleCategory("Miscellaneous")}
          >
            Others
          </li>
          ...
          <div>
            ...
            {isSearchClicked && (
              <div className="absolute top-0 left-0 z-10 flex h-16 w-full items-center gap-2 bg-white p-2">
                <div className="closeSVG" onClick={() => {setIsSearchClicked(!isSearchClicked); setSearchReult([]);
                    searchInputRef.current.value = "";}}>
                  <svg
                    width="30"
                    height="30"
                ...
                <div className="w-full ">
                  ...
                  />
                  {searchReult && (
          <div className="searchResult absolute left-0 top-16.5 border-neutral-300 md:hidden max-h-64 w-full overflow-y-auto bg-white shadow-sm block">
            {searchReult.map((item) => (
              <Link to="/product" state={item} key={item.id}>
                <div
                  className="w-full cursor-pointer p-2 px-4 text-neutral-600 hover:bg-neutral-100 active:bg-gray-800 active:text-white"
